...
Route::get('/home/form1show', [App\Http\Controllers\mycontroller::class, 'form1show'])->name('form1show');
...
Route::get('/home/form3show', [App\Http\Controllers\mycontroller::class, 'form3show'])->name('form3show');
